...
char map[17][30] = { {25,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,27},
									...
									{11,36,37,1,2,3,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,41,3,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,41,3,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,41,3,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,10,10,51,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,10,10,4,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,10,10,24,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
									{11,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,9},
...
{
	if (!block[_block.y][_block.x].canGoUnder) {
		/*if (convertPosInBlock(getBasePlayerPos()).x == _block.x && convertPosInBlock(getBasePlayerPos()).y == _block.y + 1)*/ return sfTrue;
	}
	//if (getPlayerDirection(getViewFocus()) == 1 /*DOWN*/) {
	//	if (!block[_block.y][_block.x].canGoUnder) {
	//		printf("yayanesfddddf");
	//		return sfTrue;
	//	}
	//	//else return sfTrue;
	//}
